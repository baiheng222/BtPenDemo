...
import com.nordicsemi.nrfUARTv2.LogUtil;
import com.nordicsemi.nrfUARTv2.MainActivity;
import com.nordicsemi.nrfUARTv2.MyBtPen;

import java.util.ArrayList;

import static com.nordicsemi.nrfUARTv2.MyBtPen.PEN_STATE_MOVE;
...
public class SketchPadView extends View implements IUndoCommand
{
    ...
    public void drawTrack(int x, int y, int eventType, int pointnum)
    {
        //LogUtil.i("drawTrak x:" + x + " y: " + y + "   point num is " + pointnum);


        m_isTouchUp = false;
        if (eventType == MyBtPen.PEN_STATE_DOWN)
        {
            LogUtil.i("Pen down!!!!");
        ...
        else if (eventType == MyBtPen.PEN_STATE_MOVE)
        {
        ...
        else if (eventType == MyBtPen.PEN_STATE_UP)
        {
            LogUtil.i("Pen up !!!!!");
            m_isTouchUp = true;
